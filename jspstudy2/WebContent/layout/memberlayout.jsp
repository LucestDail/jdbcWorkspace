...
<div class="w3-bar w3-top w3-black w3-large" style="z-index:4">
  ...
  <core:if test = "${empty sessionScope.login}"><a href = "${path}/model2/member/loginForm.me"> 로그인 </a><a href = "${path}/model2/member/joinForm.me"> 회원가입 </a>
  </core:if>
  <core:if test = "${!empty sessionScope.login}"><a href = "${path}/model2/member/logout.me">로그아웃</a></core:if>
  </span>
</div>
