...
<nav class="w3-sidebar w3-bar-block w3-collapse w3-large w3-theme-l5 w3-animate-left" id="mySidebar">
  ...
  <a class="w3-bar-item w3-button w3-hover-black" href="${path}/movie/member/main.me">회원관리</a>
  <a class="w3-bar-item w3-button w3-hover-black" href="${path}/movie/board/list.do">게시판</a>
  <a class="w3-bar-item w3-button w3-hover-black" href="${path}/movie/chat/chatform.do">채팅</a>
</nav>
