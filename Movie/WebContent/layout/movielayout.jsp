...
<html>
  <head>
    ...
    <link rel="stylesheet" href="${path}/resource/assets/css/fontawesome.css">
          ...
          <div class="inner">
             ...
             <div class="w3-container w3-row">
    			<div class="w3-col s8 w3-bar">
      				<core:if test = "${!empty sessionScope.login}">
      					<div class="w3-col s4">
      						<img src="${path}/movie/member/picture/${sessionScope.picture}" class="w3-circle w3-margin-right" style="width:46px">
    					</div>
      				...
      				<core:if test = "${empty sessionScope.login}">
      					<span><strong>안녕하세요! 사이트 방문을 환영합니다!</strong></span><br>
            ...
            <nav id="menu">
              <ul>
                ...
                <li><a href="${path}/movie/board/list.do?boardname=requestmovie">요청 게시판</a></li>
                <li><a href="${path}/movie/board/list.do?boardname=discussmovie">토론 게시판</a></li>
                <li><a href="${path}/movie/board/list.do?boardname=etcsomething">기타 게시판</a></li>
              </ul>
            </nav>

            <!-- Footer -->
            <footer id="footer">
              <p class="copyright">Copyright &copy; 구디 아카데미 Since 2016
              <br>Designed by <a rel="nofollow" href="https://github.com/LucestDail">Dev Hyun</a></p>
            </footer>
