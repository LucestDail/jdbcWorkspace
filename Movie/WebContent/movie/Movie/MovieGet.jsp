	...
	$(function() {
		$.ajax({
			...
			//&itemPerPage: 1-10위 까지의 데이터가 출력되도록 설정
					url : "http://www.kobis.or.kr/kobisopenapi/webservice/rest/boxoffice/searchDailyBoxOfficeList.xml?key=14234f311919496d0877ff15e5d5c03c&targetDt=" + result + "&itemPerPage=10",
					dataType : "xml",
					success : function(data) {
						...
						if ($data.length > 0) {
							...
							table.append(tbody);
							$(".wrap").append(table);
							$(".weeklyrank").append(table);
							$(".montlyrank").append(table);
						}
					},
