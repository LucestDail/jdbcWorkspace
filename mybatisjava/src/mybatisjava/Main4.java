...
public class Main4 {
	...
	public static void main(String[] args) {
		...
		student.setStudno(1010);
		student.setName("김삿갓");
		student.setJumin("1234561234567");
		student.setId("kimsk");
		int result = session.getMapper(StudentMapper.class).insert(student);
		...
		result = session.getMapper(StudentMapper.class).update(student);
		 ...
		 * 
		 */
		System.out.println("김삿갓 학생 삭제하기");
		result = session.getMapper(StudentMapper.class).delete(1010);
